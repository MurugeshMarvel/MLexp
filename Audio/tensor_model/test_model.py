...
from data_preprocess/input_vector import SpeechCorpus, voca_size
from tensor_model/tensor_model import *
import numpy as np
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
    ...
    saver.restore(sess, tf.train.latest_checkpoint('/home/murugesan/Desktop/final year project submission materials/codes/saved_model/train'))
